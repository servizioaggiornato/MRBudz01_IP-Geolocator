@echo off
rem Follow my Github: https://github.com/servizioaggiornato
rem Coded by MRBudz01
title MRBudz01 IP Geolocation
color 8B
...
:menu
cls
echo Coded by MRBudz01
echo.
echo.
echo                         Select option 1 or 2
echo.
echo                       View your IP Address: (1)
echo.
echo                      Geolocate an IP address: (2)
echo.
echo.
echo.
goto action
...
cls
echo.
echo                            MRBudz01 GEO-IP
echo.
echo                           Victim IP Address:
echo.
set ip=127.0.0.1
set /p ip=IP: 
